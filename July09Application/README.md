...
- 툴바를 액션바로 연동하고, 옵션 메뉴와 검색(`SearchView`) 메뉴를 구성해 메뉴 선택에 반응하는 방법을 학습
- `FragmentManager`를 이용해 버튼 클릭에 따라 여러 `Fragment`를 전환하는 화면 구성 방법을 학습
- `RecyclerView`와 `RecyclerView.Adapter`, 뷰 바인딩을 연동해 리스트 데이터를 화면에 표시하는 방법을 학습
